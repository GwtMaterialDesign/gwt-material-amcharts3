        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    this.drop ? (h = z / 1.6, l = 0, "V" == u && (u = "down"), "H" == u && (u = "left"), "down" == u && (x = a + 1, A = b - h - h / 3), "up" == u && (l = 180, x = a + 1, A = b + h + h / 3), "left" == u && (l = 270, x = a + h + h / 3 + 2, A = b), "right" == u && (l = 90, x = a - h - h / 3 + 2, A = b), k = A - F / 2 + 1, m = x - E / 2 - 1, p = d.drop(g, h, l, p, y, q, r, M)) : 0 < w || 0 === B ? (0 < G && (a = d.rect(g,
...
(function () {
    ...
    d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, p, r, t) {
        ...
        var G;
        B && (u = q(10 * u), A =
            q(10 * A), x = q(10 * x), E = q(10 * E), v = q(10 * v), C = q(10 * C), z = q(10 * z), w = q(10 * w), b = q(10 * b), l = q(10 * l), c = q(10 * c), f *= 10, h *= 10, k *= 10, y *= 10, 1 > Math.abs(g) && 1 >= Math.abs(x - A) && 1 >= Math.abs(z - C) && (G = !0));
        g = "";
        var D;
        p && (F["fill-opacity"] = 0, F["stroke-opacity"] = m["stroke-opacity"] / 2, F.stroke = m.stroke);
        if (0 < l) {
            D = " M" + u + "," + (v + l) + " L" + A + "," + (C + l);
            B ? (G || (D += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + x + "," + (z + l)), D += " L" + E + "," + (w + l), 0 < k && (G || (D += " B" + (b - k) + "," + (l + c - y) + "," + (b + k) + "," + (l + c + y) + "," + E + "," + (l + w) +
                "," + u + "," + (l + v)))) : (D += " A" + f + "," + h + ",0," + H + ",1," + x + "," + (z + l) + " L" + E + "," + (w + l), 0 < k && (D += " A" + k + "," + y + ",0," + H + ",0," + u + "," + (v + l)));
            D += " Z";
            var L = l;
            B && (L /= 10);
        ...
        createEntry: function (a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) m = p.set(), a.hidden || (f = a.lineColorR, k = a.bulletBorderColorR), t = d.line(p, [0, 2 *
                    r
                    ], [r / 2, r / 2], f, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, t, "graph-stroke"), m.push(t), a.bullet && (a.hidden || (f = a.bulletColorR), t = d.bullet(p, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha)) && (d.setCN(c, t, "graph-bullet"), t.translate(r + 1, r / 2), m.push(t)), y = 0, t = r, q = r / 3;
                    else {
    ...
    d.AmMap = d.Class({
        ...
        returnInitialColorReal: function (a) {
            ...
            if (b) {
                ...
                if (k = a.image) k.setAttr("fill", c), k.setAttr("stroke", h), k.setAttr("stroke-width", f), k.setAttr("fill-opacity", e), k.setAttr("stroke-opacity",
                    g);
        ...
        zoomToObject: function (a) {
            if (a) {
                ...
                isNaN(e) || (isNaN(b) || isNaN(c) ? this.zoomTo(e,
                    f, h, g) : this.zoomToLongLat(e, c, b, g));
                ...
                "MapArea" == a.objectType && (g = a.displayObject.getBBox(), f = this.mapScale, b = (g.x + this.diffX) * f, c = (g.y + this.diffY) * f, e = g.width * f, g = g.height * f, k = a.autoZoomReal && isNaN(a.zoomLevel) ? e / k > g / l ? .8 * k / e : .8 * l / g : a.zoomLevel, l = this.zoomControl, k = d.fitToBounds(k,
                    l.minZoomLevel, l.maxZoomLevel), isNaN(a.zoomX) && isNaN(a.zoomY) && isNaN(a.zoomLatitude) && isNaN(a.zoomLongitude) && this.zoomToMapXY(k, b + e / 2, c + g / 2));
        ...
        clickMapObject: function (a, b) {
            ...
            if (c.chartCreated && !c.preventHover &&
                c.checkTouchDuration(b) && !c.mapWasDragged && c.checkIfClickable(a) && !c.mapWasPinched) {
                c.selectObject(a);
                var d = c.zoomLevel(),
                    g = c.mapSet.getBBox(),
        ...
        checkIfClickable: function (a) {
            ...
            return this.selectedObject == a && b ? !0 : this.selectedObject != a || b ? !0 === a.selectable || "MapArea" == a.objectType && a.autoZoomReal || a.url || a.linkToObject || 0 < a.images.length || 0 < a.lines.length ||
            !isNaN(a.zoomLevel) || !isNaN(a.zoomX) || !isNaN(a.zoomY) || a.description ? !0 : !1 : !1
        },
        resizeMap: function () {
            var a = this.mapSet;
            if (a) {
        ...
        zoomX: function () {
            return this.mapSet ? Math.round(1E4 *
                this.mapContainer.x / this.mapWidth) / 1E4 : NaN
        },
        zoomY: function () {
                ...
                for (g = 0; g < k; g++) {
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n)
                        if (3 == f.nodeType || 4 == f.nodeType) {
                            ...
                            var p;
                            void 0 !== a[b][l] ? void 0 === a[b][l].length ? (p = a[b][l], a[b][l] = [], a[b][l].push(p), a[b][l].push({}), p = a[b][l][1]) :
                                "object" == typeof a[b][l] && (a[b][l].push({}), p = a[b][l][a[b][l].length - 1]) : (a[b][l] = {}, p = a[b][l]);
        ...
        getObjectById: function (a) {
            ...
            if (c =
                    this.getObject(a, b.images)) return c;
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage: function (a, b) {
            ...
            if (n) {
                ...
                -F / 2 : F / 2, D.translate(E, q, NaN, !0))) : B && (D = e.path(B), u = D.getBBox(), a.centeredReal ? (E = -u.x * w - u.width * w / 2, isNaN(a.right) || (E = -E), q = -u.y * w - u.height * w / 2, isNaN(a.bottom) || (q = -q)) : E = q = 0, D.translate(E, q, w, !0), D.x = E, D.y = q);
        ...
        getCoordinates: function (a, b) {
            ...
            if (!isNaN(a)) {
                ...
                if (!isNaN(this.arc) && 0 !== this.arc && this.arcRadius) {
                    var n = 0;
                    c <
                    g && (n = c, c = g, g = n, n = e, e = f, f = n, n = Math.PI);
                    k = this.arcRadius[b];
                    0 > this.arc && (l = -l);
        ...
        init: function (a, b) {
            if (this.enabled) {
                ...
                void 0 !== k && (h = d.text(b, k, n, m, l, "right"), h.translate(this.width,
                    l / 2 - 1), d.setCN(a, h, "value-legend-max-label"), f.push(h), h = h.getBBox().height);

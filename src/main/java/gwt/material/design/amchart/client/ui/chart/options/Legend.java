...
import gwt.material.design.amchart.client.ui.chart.events.HasLegendHandlers;
import gwt.material.design.amchart.client.ui.chart.events.legend.*;
import gwt.material.design.amchart.client.ui.chart.events.object.LegendData;
...
public class Legend extends ChartOptions implements HasLegendHandlers {
    ...
    public void setLegendBackgroundColor(Color color) {
        setLegendBackgroundColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setMarkerBorderColor(Color color) {
        setMarkerBorderColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setMarkerDisabledColor(Color color) {
        setMarkerDisabledColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setPosition(LegendPosition position) {
        getAmLegend().position = position.getName();
    }
    ...
    public void setSwitchColor(Color color) {
        setSwitchColor(ColorHelper.setupComputedBackgroundColor(color));
    }

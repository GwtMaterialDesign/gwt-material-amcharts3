 ...
 * #L%
 */
package gwt.material.design.amchart.client.ui.chart.base;
...
import gwt.material.design.amchart.client.ui.chart.events.HasChartHandlers;
import gwt.material.design.amchart.client.ui.chart.events.core.*;
import gwt.material.design.amchart.client.ui.chart.events.object.CoreData;
...
import gwt.material.design.amchart.client.ui.chart.options.Balloon;
import gwt.material.design.amchart.client.ui.chart.options.DataLoader;
import gwt.material.design.amchart.client.ui.chart.options.Legend;
import gwt.material.design.amchart.client.ui.chart.plugins.export.ExportOption;
import gwt.material.design.amchart.client.ui.chart.plugins.export.js.AmExportOption;
import gwt.material.design.amchart.client.ui.chart.resources.ChartClientBundle;
import gwt.material.design.amchart.client.ui.chart.resources.ChartClientDebugBundle;
import gwt.material.design.amchart.client.ui.chart.resources.ChartResourceLoader;
...
public abstract class AbstractChart extends MaterialWidget implements JsLoader, HasChartHandlers {
    ...
    protected void loadDefaults() {
        ...
        setPath(GWT.getModuleName() + "/amcharts/");
    }
    ...
    /**
     * The chart creates {@link gwt.material.design.amchart.client.ui.chart.options.Balloon} class itself. If you want to customize balloon, get balloon instance using this
     * property, and then change balloon's properties.
     */
    public void setBalloon(Balloon balloon) {
        getChart().balloon = balloon.getAmBalloon();
    }
    ...
    public void setBorderColor(Color color) {
        setBorderColor(ColorHelper.setupComputedBackgroundColor(color));
    }
     ...
     */
    public void setExport(ExportOption option) {
        loadPlugin(ChartPlugin.EXPORT);
        getChart().export = option.getAmExportOption();
    }

    public AmExportOption getAmExport() {
        return getChart().export;
    }
     ...
     * Duration of fade-out is set in {@link Balloon} class. Default to 150
     */
    ...
    public void setLanguage(Language language) {
        ...
        ChartResourceLoader.loadLanguage(language);
    }
    ...
    public void addLabel(int x, int y, String text, String align, int size, Color color, int rotation, double alpha, boolean bold, String url) {
        addLabel(x, y, text, align, size, ColorHelper.setupComputedBackgroundColor(color), rotation, alpha, bold, url);
    }
    ...
    public void addTitle(String text, int size, Color color, double alpha, boolean bold) {
        addTitle(text, size, ColorHelper.setupComputedBackgroundColor(color), alpha, bold);
    }
     ...
     */
    public void makeChart(String containerId, Object config, int delay) {

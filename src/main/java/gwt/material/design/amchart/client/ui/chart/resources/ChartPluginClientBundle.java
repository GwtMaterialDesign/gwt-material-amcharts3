...
public interface ChartPluginClientBundle extends ClientBundle {
    ...
    @Source("js/plugins/animate/animate.min.js")
    TextResource animateJs();

    @Source("js/plugins/dataloader/dataloader.min.js")
    TextResource dataLoaderJs();

    @Source("js/plugins/export/export.min.js")
    TextResource exportJs();

    @Source("js/plugins/export/export.min.css")
    TextResource exportCss();

    @Source("js/plugins/responsive/responsive.min.js")

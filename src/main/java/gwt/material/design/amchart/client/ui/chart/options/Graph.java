...
import gwt.material.design.amchart.client.ui.chart.base.constants.GraphBullet;
...
public class Graph extends ChartOptions {
    ...
    public String getBalloonColor() {
        return getAmGraph().balloonColor;
    }
     ...
     */
    public void setBullet(GraphBullet bullet) {
        getAmGraph().bullet = bullet.getName();
    }
    ...
    public void setBulletBorderColor(Color color) {
        setBulletBorderColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setBulletColor(Color color) {
        setBulletColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setFillColors(Color color) {
        setFillColors(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setLegendColor(Color color) {
        setLegendColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setNegativeFillColors(Color color) {
        setNegativeFillColors(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setNegativeLineColor(Color color) {
        setNegativeLineColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public GraphType getType() {
        String type = getAmGraph().type;
        return type != null ? GraphType.valueOf(type) : null;
    }

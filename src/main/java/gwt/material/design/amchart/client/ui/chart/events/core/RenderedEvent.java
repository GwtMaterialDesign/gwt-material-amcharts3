 ...
 * #L%
 */
package gwt.material.design.amchart.client.ui.chart.events.core;
...
/**
 * Dispatched when the chart is build for the first time and each time after chart.validateNow() method is called and
 * the chart is build.
 *
 * @author kevzlou7979
 */
public class RenderedEvent extends GwtEvent<RenderedEvent.RenderedHandler> {
    ...
    public RenderedEvent(CoreData data) {
        this.data = data;
    }

 ...
 * #L%
 */
package gwt.material.design.amchart.gen;
...
public class MapLayerGenerator {
    ...
    protected static void generateMapLayerEnums() throws IOException {
        ...
        String path = "src/main/resources/gwt/material/design/amchart/client/ui/maps/resources/layers/";
        ...
        File template = new File("src/main/java/gwt/material/design/amchart/gen/TemplateMapLayer.txt");
        if (!template.isFile()) {
        ...
        File target = new File("src/main/java/gwt/material/design/amchart/client/ui/maps/base/constants/MapLayer.java");
    ...
    protected static void generateMapClientBundle() throws IOException {
        ...
        // Look for Template File
        File template = new File("src/main/java/gwt/material/design/amchart/gen/TemplateClientBundle.txt");
        if (!template.isFile()) {
            throw new FileNotFoundException(template.getAbsolutePath());
        }
        ...
        //time to write it to the destination
        File target = new File("src/main/java/gwt/material/design/amchart/client/ui/maps/resources/MapLayerClientBundle.java");
        Files.write(Paths.get(target.toURI()), templateString.getBytes("UTF-8"));

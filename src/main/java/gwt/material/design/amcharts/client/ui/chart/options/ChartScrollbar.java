...
import gwt.material.design.amcharts.client.ui.chart.base.constants.DragIcon;
import gwt.material.design.amcharts.client.ui.chart.js.options.AmCategoryAxis;
import gwt.material.design.amcharts.client.ui.chart.js.options.AmChartScrollbar;
...
/**
 * Create a scrollbar for {@link SerialChart} and
 * {@link XyChart} charts.
 *
...
public class ChartScrollbar extends ChartOptions {
    ...
    public void setBackgroundColor(Color color) {
        setBackgroundColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setGraphFillColor(Color color) {
        setGraphFillColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setGraphLineColor(Color color) {
        setGraphLineColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setGridColor(Color color) {
        setGridColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setSelectedBackgroundColor(Color color) {
        setSelectedBackgroundColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setSelectedGraphFillColor(Color color) {
        setSelectedGraphFillColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setSelectedGraphLineColor(Color color) {
        setSelectedGraphLineColor(ColorHelper.setupComputedBackgroundColor(color));
    }

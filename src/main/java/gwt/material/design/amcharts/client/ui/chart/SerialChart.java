...
import gwt.material.design.amcharts.client.ui.chart.events.HasSerialChartHandlers;
import gwt.material.design.amcharts.client.ui.chart.events.object.SerialChangedData;
import gwt.material.design.amcharts.client.ui.chart.events.object.SerialZoomedData;
import gwt.material.design.amcharts.client.ui.chart.events.serial.SerialChangedEvent;
import gwt.material.design.amcharts.client.ui.chart.events.serial.SerialZoomedEvent;
...
public class SerialChart extends RectangularChart implements HasSerialChartHandlers {
    ...
    public void zoomToDates(Date start, Date end) {
        ...
        getChart().zoomToDates(JsDate.create(start.getTime()), JsDate.create(end.getTime()));
    }

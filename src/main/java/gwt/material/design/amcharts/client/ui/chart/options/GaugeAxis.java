...
import gwt.material.design.amcharts.client.ui.chart.events.HasGaugeAxisHandlers;
import gwt.material.design.amcharts.client.ui.chart.events.gauge.ClickBandEvent;
import gwt.material.design.amcharts.client.ui.chart.events.gauge.RollOutBandEvent;
import gwt.material.design.amcharts.client.ui.chart.events.gauge.RollOverBandEvent;
import gwt.material.design.amcharts.client.ui.chart.events.object.GaugeAxisData;
import gwt.material.design.amcharts.client.ui.chart.js.AmChart;
import gwt.material.design.amcharts.client.ui.chart.js.options.AmGaugeAxis;
import gwt.material.design.amcharts.client.ui.chart.js.options.AmGaugeBand;
...
/**
 * Creates an axis for {@link AngularGauge} charts, multiple can be
 * assigned.
 *
...
public class GaugeAxis extends ChartOptions implements HasGaugeAxisHandlers {
    ...
    public void setAxisColor(Color color) {
        setAxisColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setBandOutlineColor(Color color) {
        setBandOutlineColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setBottomTextColor(Color color) {
        setBottomTextColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setTickColor(Color color) {
        setTickColor(ColorHelper.setupComputedBackgroundColor(color));
    }
    ...
    public void setTopTextColor(Color color) {
        setTopTextColor(ColorHelper.setupComputedBackgroundColor(color));
    }
